...
from quantization.prismaquant.calibrate_allocator import (
...
from quantization.prismaquant.interaction_refine import RefinementUnit, UnitOption, expand_unit_assignment
    ...
    try:
        ...
        for idx, (choices, bits_total) in enumerate(
            ...
            if payload["expert_granularity"] == "layer":
                from quantization.prismaquant.allocator import expand_moe_assignment
