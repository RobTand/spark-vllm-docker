...
from dynaquant.kernels.pack_utils import pack_Nbit_tensor
from dynaquant.kernels.fused_dequant_gemv import dynaquant_linear as _fused_linear
...
class DynaQuantLinear(nn.Module):
    ...
    def dequantize(self) -> torch.Tensor:
        ...
        from dynaquant.kernels.pack_utils import unpack_Nbit_tensor
